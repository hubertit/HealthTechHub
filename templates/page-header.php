                                    ...
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                <h6 class="info-title">+250 788 305 829</h6>
                                                <div class="info-sub-title">info@thehealthtech.org</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                <h6 class="info-title">KN 78 Street, Kigali</h6>
                                                <div class="info-sub-title">Norrsken</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="info-item">
                                            ...
                                            <div class="info-content">
                                                ...
                                                <div class="info-sub-title">+250 788 305 829</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
