...
<!-- Mirrored from htmldemo.net/mitech/our-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Jul 2022 09:46:24 GMT -->
<head>
    <meta charset="utf-8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 timeline-col left timeline-feature">
                                                    <div class="inner">
                                                        ...
                                                        <div class="photo">
                                                            <img src="assets/images/timeline/timeline-image-01.webp" alt="timeline-image-01" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 timeline-col left timeline-feature">
                                                    <div class="inner">
                                                        ...
                                                        <div class="photo">
                                                            <img src="assets/images/timeline/timeline-image-02.webp" alt="timeline-image-01" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 timeline-col right timeline-info">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 timeline-col left timeline-feature">
                                                    <div class="inner">
                                                        ...
                                                        <div class="photo">
                                                            <img src="assets/images/timeline/blog-07-500x350.webp" alt="timeline-image-01" class="img-fluid">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 timeline-col right timeline-info">
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                ...
                                <li><a href="#" class="hover-style-link text-color-primary">www.mitech.xperts.com</a></li>
                            </ul>
                        </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 text-center text-md-start">
                            <span class="copyright-text">&copy; 2021 Mitech. <a href="#">All Rights Reserved.</a></span>
                        </div>
