        ...
        <div class="col-md-12 mt-4 mb-5">
          <form action="insert.php" method="post">
            ...
            <fieldset>
              ...
              <label>Are you a startup from the HealthTech Hub Africa?* </label><br>
              <input type="radio" id="under_13" value="under_13" name="start_up"><label for="under_13" class="light">Yes</label><br>
              ...
              <input type="radio" id="under_13" value="under_13" name="user_age"><label for="under_13" class="light">Yes</label>
              <input type="radio" id="Yes" value="over_13" name="existing"><label for="No" class="light">No</label>
