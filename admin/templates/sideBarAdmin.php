<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu HTH Impact">
                <a href="#HTH Impact" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <i data-feather="box"></i>
                        <span>HTH Impact</span>
                    </div>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right">
                            <polyline points="9 18 15 12 9 6"></polyline>
                ...
                <ul class="collapse submenu list-unstyled" id="HTH Impact" data-parent="#accordionExample">

                    <li class='addCar'>
                        <a href="addCar"> Add New</a>
                    </li>
                    <li class='HTH Impact'>
                        <a href="HTH Impact"> Report</a>
                    </li>
                </ul>
            </li>
