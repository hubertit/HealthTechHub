                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Post Title" name="postTitle" value="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea name="postDetails" placeholder="Post Details" class="form-control" id="" cols="30" rows="5"></textarea>
                                                <script>
                                    ...
                                    <button class="btn btn-primary " type="submit" name="addPost">Save Post</button>
                                </form>
                            </div>
                        </div>
                    </div>
