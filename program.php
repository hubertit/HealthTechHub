...
<head>
    ...
    <!-- Font Icons -->
    <link media="all" rel="stylesheet" href="css2/fonts/icomoon/icomoon.css">
    <link media="all" rel="stylesheet" href="css2/fonts/roxine-font-icon/roxine-font.css">
    ...
    <!-- Bootstrap 4 -->
    <link media="all" rel="stylesheet" href="css2/bootstrap.css">
    <!-- Rev Slider -->
    ...
    <!-- Theme CSS -->
    <link media="all" rel="stylesheet" href="css2/main.css">
    <!-- Custom CSS -->
    <link media="all" rel="stylesheet" href="css2/custom.css">
</head>
                ...
                <div id="nav-section">
                    <div class="bottom-header container-fluid mega-menus" id="mega-menus">
                        <nav class="navbar navbar-toggleable-md no-border-radius no-margin mega-menu-multiple" id="navbar-inner-container">
                            ...
                            <a class="navbar-brand mr-auto m-sm-auto" href="index.php"> <img src="img/light-logo.png" alt="HealthTech Hub"> <img src="img/logo-dark.png" alt="HealthTech"> </a>
                            <div class="collapse navbar-collapse flex-row-reverse" id="mega-menu">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown" data-animation="fadeIn">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="index.php" data-title="Home"> Partners </a>
                                    </li>
                                    <li class="dropdown dropdown-full-width-g" data-animation="fadeIn">
                                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" data-title="Pages">Challenges </a>
                                    </li>
                                    <li>
                                        <a href="about.html"> startups </a>
                                    </li>
                                    <li>
                                        <a href="team.html"> IWG </a>
                                    </li>
                        ...
                        <div class="centered">
                            <div class="container">
                                <div class="visual-text visual-center">
                                    <h1 class="visual-title visual-sub-title text-white">Program</h1>
                                    <div class="breadcrumb-block">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#">  Growth start-ups </a></li>
                                            <li class="breadcrumb-item"><a href="#"> Scale-up start-ups </a></li>
                                           <!---- <li class="breadcrumb-item"><a href="#"> No Sidebar </a></li>-->
                                            <!---<li class="breadcrumb-item active"> 6 Col </li>-->
                                        </ol>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="content-wrapper">
                    <section class="content-block portfolio-block">
                        <ul class="filter-nav filter-nav-v2 text-center button-group filter-button-group">
                            <li>
                                <button class="is-checked" data-filter="*">Growth start-ups</button>
                            </li>
                            <li>
                                <button data-filter=".ui">Scale-up start-ups</button>
                            </li>
                        </ul>
                        <div class="container-fluid">
                            <div class="row masonary-block grid">
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ui photography">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Insightiv.png" alt="images description"></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 photography">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Medtech África.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ui programming">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Klarah.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ecommerce">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Lifesten Health.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 programming ui">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Companionapp.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 photography">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Denga Logistics Limited.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 programming">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Digi-Dibia Health-Tech Inc.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ecommerce">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/DotPharma Ltd.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ecommerce">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/IVUZE SOFTWARE Ltd.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                                ...
                                                <div class="info">
                                                    <h2 class="content-title">IVUZE SOFTWARE Ltd</h2>
                                                </div>
                                            </div>
                                        </div>
                                    </figure>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 photography">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/E-Heza Data Solutions.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ui programming">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/Eden Care.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
                                ...
                                <div class="gallery-item col-md-6 col-lg-6 col-xl-2 ecommerce">
                                    <figure class="caption-hover-full">
                                        <a class="fancy-pop" href="portfolio-single.html"></a>
                                        <div class="image-wrapper"><img src="img/GLOBAL PRE-ECLAMPSIA INITIATIVE.png" alt="images description"></div>
                                        <div class="image-details">
                                            <div class="figcaption">
                                                <div class="trigger">
                                                    <div class="custom-icon-plus"><span class="sr-only">&nbsp;</span></div>
